...
**デスクトップ固有**（[#16](https://github.com/schwarz9791/chatter-agent/issues/16) 窓の位置/サイズ・クリック透過・終了 → **[#75](https://github.com/schwarz9791/chatter-agent/issues/75) 常駐（Dock 非表示・メニューバー・ミュート）は完了** → [#76](https://github.com/schwarz9791/chatter-agent/issues/76) 設定 UI）/ [#25](https://github.com/schwarz9791/chatter-agent/issues/25)（XR 固有）。
