...
namespace ChatterMascot.Tests
{
    ...
    public sealed class SettingsStoreTests
    {
        ...
        {
            var store = Store();
            Assert.That(store.Save(new MascotSettings(true, "cmd+shift+m")), Is.True);
        ...
        {
            _file = SettingsJson.Write(new MascotSettings(true, HotKeySpec.Default));
            _stamp = "1:100";
        ...
        {
            _file = SettingsJson.Write(new MascotSettings(false, HotKeySpec.Default));
            _stamp = "1:100";
        ...
        public void SurvivesAThrowingWriter()
        {
            ...
            Assert.That(store.Save(new MascotSettings(true, HotKeySpec.Default)), Is.False);
            Assert.That(_warnings, Has.Count.EqualTo(1));
        }
